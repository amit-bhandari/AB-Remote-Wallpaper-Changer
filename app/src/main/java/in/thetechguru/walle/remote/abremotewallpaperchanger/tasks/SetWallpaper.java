...
public class SetWallpaper extends Job {
    ...
    @Override
    public void onAdded() {
        Log.d("SetWallpaper", "onAdded: Job added to queue for changing wallpaper");
    }

    @Override
    public void onRun() throws Throwable {
        Log.d("SetWallpaper", "onRun: starting again");
        ...
        while (status==JOB_STATUS.RUNNING) {
            ...
            Log.d("SetWallpaper", "polling status: " + status);
    ...
    protected RetryConstraint shouldReRunOnThrowable(@NonNull Throwable throwable, int runCount, int maxRunCount) {
        Log.d("SetWallpaper", "shouldReRunOnThrowable: " + runCount);
